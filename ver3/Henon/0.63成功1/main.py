...
def control():
    ...
    ax1.scatter(fix_Hx, fix_Hx, s = 25, zorder=2, c = 'yellow', label="")
    ax1.scatter(RC_fix, RC_fix, s = 25, zorder=2, c = 'black', label="")
    ...
    fig = plt.figure(figsize = (5, 5), dpi = 100)
    ax2 = fig.add_subplot(1,1,1)
    ax2.plot(t, fix_Hx_plot, lw = 3, zorder=1, c = 'yellow', label="")
